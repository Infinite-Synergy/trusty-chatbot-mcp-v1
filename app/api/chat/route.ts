...
export async function POST(req: Request) {
  try {
    ...
    console.log('📥 [API Route] Incoming messages:', messages);
    console.log('📤 [API Route] Sending to Letta:', { 
    ...
    // DEBUG: Log when starting stream
    console.log('🌊 [API Route] Starting stream response from Letta agent');
