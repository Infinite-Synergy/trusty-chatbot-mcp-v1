...
export function Sidebar({ className, onNewChat }: SidebarProps) {
  ...
  const chatHistory = [
    { id: 1, title: "Top 3 Sales performers", date: "Yesterday" },
    { id: 2, title: "Sales by Region", date: "Yesterday" },
  ]

  return (
    <div className={cn("flex flex-col h-full bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-hidden min-h-0", className)}>
      {/* Header */}
